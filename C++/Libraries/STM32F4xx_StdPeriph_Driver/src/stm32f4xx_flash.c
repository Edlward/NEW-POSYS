...
@verbatim   
 ...
 +-------------------------------------------------------------------------------------------------------------------+  
   @note When VOS bit (in PWR_CR register) is reset to '0í, the maximum value of HCLK is 144 MHz.
...
FLASH_Status FLASH_GetStatus(void)
{
  ...
  /*
	FLASH_FLAG_BSY∫ÕFLASH_BUSYµƒ«¯±
	«∞’ﬂ «Œ™¡À∂‘ºƒ¥Ê∆˜Ω¯–––ﬁ∏ƒµƒ÷µ
	∫Û’ﬂ «∑µªÿ∏¯”√ªßø¥µƒ√∂æŸ÷µ
	*/
...
{ 
	//__IO -> volatile  FLASH_Status√∂æŸ¿‡–Õ
