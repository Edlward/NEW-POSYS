...
void icm_update_gyro_rate(int gyroNum)
{
  ...
  data1[2] = (raw[4]<<8) | raw[5];
	...
	gyro[0] = data1[0]/130.774388888889*0.707106781186547-data1[1]/130.774388888889*0.707106781186547;
	gyro[1] = data1[0]/130.774388888889*0.707106781186547+data1[1]/130.774388888889*0.707106781186547;
...
void icm_update_acc(int gyroNum)
{
  ...
  16384 LSB/g
  */	
	acc[0] = data1[0]/16384.0*0.707106781186547-data1[1]/16384.0*0.707106781186547;
	acc[1] = data1[0]/16384.0*0.707106781186547+data1[1]/16384.0*0.707106781186547;
